...
## 2026-06-10 – Healthcare AI topic-adherence evaluation datasets
...
- Added the issue triage workflow source under `.github\workflows\issue-triage.md` and committed the generated `.github\workflows\issue-triage.lock.yml` so live issue triage can run through GitHub Actions.
